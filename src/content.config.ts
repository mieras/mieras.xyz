...
const main = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/main' }),
  schema: z.object({
    title: z.string(),
    subtitle: z.string(),
    contact: z.string(),
...
const marquee = defineCollection({
  loader: glob({ pattern: '**/*.{yaml,json}', base: './src/content/marquee' }),
...
const seo = defineCollection({
  loader: glob({ pattern: '**/*.{yaml,json}', base: './src/content/seo' }),
  schema: z.object({
    person: z.object({
      name: z.string(),
      jobTitle: z.string(),
...
export const collections = { footer, main, marquee, seo };
